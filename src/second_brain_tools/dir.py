...
def ic_03c3a(dir_code):
    ...
    """
    if dir_code == "03C3A1":
        dir_path = "03_Knowledge-Base/03C_IT-Skills/03C3_Software/03C3A_Application/03C3A1_Unreal-Engine/"
    elif dir_code == "03C3A2":
        dir_path = "03_Knowledge-Base/03C_IT-Skills/03C3_Software/03C3A_Application/03C3A2_Blender/"
    elif dir_code == "03C3A3":
        dir_path = "03_Knowledge-Base/03C_IT-Skills/03C3_Software/03C3A_Application/03C3A3_Unity/"
    elif dir_code == "03C3A4":
        dir_path = "03_Knowledge-Base/03C_IT-Skills/03C3_Software/03C3A_Application/03C3A4_MariaDB/"
    else:
        dir_path = DIR_NOT_FOUND
    return dir_path
# ic_03c3a-Ended
